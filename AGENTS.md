...
This project is indexed by GitNexus as **EmbeddingServer** (567 symbols, 1234 relationships, 47 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
